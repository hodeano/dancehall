...
export default function ProblemSquad() {
...
<div className="full-page" >
            ...
            <div className="overload-shot">
             <img src="https://d3cjsf0o8cd718.cloudfront.net/problemsquad-header.jpg" />
             </div>
...
<Divider/>
            ...
            <div className="player_holder">  
             <ReactPlayer controls={true} url='https://youtu.be/nnON-Mzi5wk' />
            </div>
     ...
     Welcome to PROBLEM SQUAD dance course here you will learn their choreography and steps
     </Typography>
     <br/>
...
<br/>
      ...
      <Typography align="center" variant="h4"  >
       ...
       <Divider light />
                  ...
                  <ListItem button onClick={() =>{ history.push('/problem-squad-swift') }}  >   
                  <ListItemText primary="SWIFT" />
                  </ListItem>

                  <Divider />

                  <ListItem button divider onClick={() =>{ history.push('/problem-squad-falla-falla') }}  >
                  <ListItemText primary="FALLA FALLA " />
                  </ListItem>

                  <ListItem button  onClick={() =>{ history.push('/problem-squad-mix-up') }}  >
                  <ListItemText primary="MIX UP" />
                  </ListItem>
       ...
       <Divider light />
                  ...
                  <ListItem button  onClick={() =>{ history.push('/problem-squad-interview') }}  > 
                  <ListItemText primary="INTERVIEW WITH LEE" />
                  </ListItem>
