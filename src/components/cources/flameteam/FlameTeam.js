...
export default function FlameTeam() {
...
<div className="full-page" >
            ...
            <div className="overload-shot">
             <img src="https://d3cjsf0o8cd718.cloudfront.net/flameteam team header.jpg" />
             </div>
...
<Divider/>
     ...
     Welcome to FLAME TEAM dance course here you will learn their choreography and steps
     </Typography>
     <br/>
...
<br/>
    ...
    <List  mx={style}  component="nav" aria-label="mailbox folders">
                  ...
                  <ListItem button onClick={() =>{ history.push('/flame-team-i-wish') }}  >
                  <ListItemText primary="Masicka – I Wish" />
                  </ListItem>
      ...
      <Typography align="center" variant="h4"  >
       ...
       <Divider light />
                  ...
                  <ListItem button onClick={() =>{ history.push('/flame-team-compass') }}  >   
                  <ListItemText primary="Compass" />
                  </ListItem>

                  <Divider />

                  <ListItem button onClick={() =>{ history.push('/flame-team-hi5') }}  >
                  <ListItemText primary=" HI 5 " />
                  </ListItem>
